...
use RaazPuspa\Passport\TokenRepository;
use RaazPuspa\Passport\Http\Controllers\AuthorizedAccessTokenController;
...
class AuthorizedAccessTokenControllerTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->controller = new RaazPuspa\Passport\Http\Controllers\AuthorizedAccessTokenController(
    ...
    public function test_tokens_can_be_retrieved_for_users()
    {
        ...
        $token1 = new RaazPuspa\Passport\Token;
        $token2 = new RaazPuspa\Passport\Token;
    ...
    public function test_tokens_can_be_deleted()
    {
        ...
        $token1 = Mockery::mock(RaazPuspa\Passport\Token::class.'[revoke]');
        $token1->id = 1;

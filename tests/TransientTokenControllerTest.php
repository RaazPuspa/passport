...
class TransientTokenControllerTest extends TestCase
{
    ...
    {
        $cookieFactory = Mockery::mock('RaazPuspa\Passport\ApiTokenCookieFactory');
        ...
        $controller = new RaazPuspa\Passport\Http\Controllers\TransientTokenController($cookieFactory);

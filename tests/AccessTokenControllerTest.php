...
class AccessTokenControllerTest extends TestCase
{
    ...
    public function test_a_token_can_be_issued()
    {
        ...
        $tokens = Mockery::mock(RaazPuspa\Passport\TokenRepository::class);
        ...
        $controller = new RaazPuspa\Passport\Http\Controllers\AccessTokenController($server, $tokens, $jwt);
